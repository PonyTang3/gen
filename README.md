...
```BASH
go get github.com/PonyTang3/gen
...
- Postgres and SQLite driver support for sql.ColumnType.Nullable() ([#3](https://github.com/PonyTang3/gen/issues/3))
